...
@GetMapping("/posts/users/{userId}")
    ...
    public ResponseEntity<CommentDTO[]> getAllCommentsForPostId(@PathVariable Long postId){
        ResponseEntity<CommentDTO[]> comments= postService.getAllCommentsForPostId(postId);
